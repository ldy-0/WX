...
// 短信验证码
export const SMS_REGISTER = 1;
export const SMS_CHANGEPWD = 2;

// 用户身份
export const DRUGSTORE = 0;
export const CITY_DEALER = 1;
export const PROVINCE_DEALER = 2;
