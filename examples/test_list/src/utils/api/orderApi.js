...
function confirmOrder(options) {
  return api.postRC('v2/order/confirm', options.params, options.message, options.success, options.fail, options.complete)
}
...
function submitOrder(options){
  return api.post('v2/order/submit', options.params, options.message, options.success, options.fail, options.complete)
}
