 ...
 * post请求
 */
async function post(url, params, message, success, fail, complete, method) {
 ...
 */
async function postRC(url, params, message, success, fail, complete) {
  if (params) {
    console.log(url)
    console.log(params)
  }
...
async function uploadFile(filePath, success, fail, complete, onProgress) {
  ...
  var task = await wepy.uploadFile(option)
  return task
}
