...
wxTimer.prototype = {
  //开始
  start: function(self) {
    var hmsArr = this.beginTime.toString().split(":");
    let day = parseInt(hmsArr[0] / 24);
    if (day > 0) {
      let hours = hmsArr[0] - 24 * day;
      console.log(hours);
      this.beginTime = hours + ":" + hmsArr[1] + ":" + hmsArr[2];
    }
