...
let config = {
  bucket: 'yipingda',
  appid: '1257351977',
  sid: 'AKIDPl3CB2ZnW9bDeujymPq6C7uVzIPKLf4H',
  skey: 'LYcU4Wt8E8qNnGftvlQArnZEudIIJBrM',
  region: 'sh',
  currentSig: null,
  expireTime: null
};
...
let uploadFile = async (filePath, options) => {
  try {
    ...
    const uploadRes = await u.uploadFile(uploadOpt);
    console.log('upload result --', uploadRes);
    const parseRes = JSON.parse(uploadRes);
