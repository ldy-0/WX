...
<el-main>
    <el-table :data="tableData" stripe v-loading="listLoading" element-loading-text="给我一点时间" style="width: 100%" >
      <el-table-column label="案例名字" prop="id"></el-table-column>
...
import { getCaseList_api, deleteFlowPackage_api,addFlowPackage_api,editFlowPackage_api } from '@/api/admin' 
  ...
  methods: {
    ...
    // body
      getList() { //获取列表
        ...
        getCaseList_api(sendData).then(response => {
