    ...
    <scroll-view scroll-y="{{canScroll ? true : false}}" style='height: 100%;'>
      ...
      <view class="main_wrap s_fc_2">
        ...
        <view class='appointment_wrap'>
          ...
          <textarea maxlength="50" class='appointment s_fc_1' placeholder-class="s_fc_1" value='{{info}}' bindfocus="focusTextarea" @blur='blur' @input='getInfo'></textarea> 
...
export default class Waiterhome extends wepy.page {
  ...
  data = {
    activityTitle: '来店选嘉实多极护专享，赢取极护品牌体验之旅特权',
  ...
  methods = {
    ...
    copy(){
      // let data = `来店保养选嘉实多极护\r\n赢取极护品牌体验之旅特权\r\n领略专业赛道的速度与激情\r\n${this.info}`;
      let data = `来店保养选嘉实多极护，赢取极护品牌体验之旅特权，领略专业赛道的速度与激情，${this.info}`;
